...
draft: true
---
最近在 Obsidian 里写博客写得有点烦。因为换了 Fuwari 博客主题后，我的本地写博客语法 -> Fuwari 主题语法需要不少变动。另外，图片的引用也需要处理。我经常写完后就直接把源文件扔了，但是这两天碰到的 YOLO 恰好解决了我的困境。
...
![YOLO 插件安装](assets/img/obsidian-yolo/Pasted%20image%2020260618130052.png)
...
![Provider 配置界面](assets/img/obsidian-yolo/Pasted%20image%2020260618134726.png)
![Provider 配置界面 2](assets/img/obsidian-yolo/Pasted%20image%2020260618135345.png)
...
![Agent 工具配置](assets/img/obsidian-yolo/Pasted%20image%2020260618160903.png)

但是在和 Agent 对话时会发现其实它并不兼容终端 shell 命令的运行。需要在【 Agent-Agents-Default(或者新增的 Agent)】 的工具里面再次启用。

![Agent 工具启用](assets/img/obsidian-yolo/Pasted%20image%2020260618161202.png)

同时还得保证运行的命令不在禁止列表里。【Agent-管理工具-终端命令-配置】

![终端命令配置](assets/img/obsidian-yolo/Pasted%20image%2020260618161405.png)
...
![对话侧边栏](assets/img/obsidian-yolo/Pasted%20image%2020260618162058.png)
...
![快捷对话框](assets/img/obsidian-yolo/Pasted%20image%2020260618163233.png)
...
![Tab 补全配置](assets/img/obsidian-yolo/Pasted%20image%2020260618163412.png)
...
![记忆系统界面](assets/img/obsidian-yolo/Pasted%20image%2020260618163928.png)
