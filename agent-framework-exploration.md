...
# 当主流 Agent 框架无法适配需求时，我们造了什么

> 我们从 LangChain/Langgraph 到 Dify/n8n，从 OpenHands/Suna 到 Claude Code，学习过每一个主流 Agent 框架，但没有一个能完美适配我们的业务需求。后来我们发现，问题不在于"选哪个框架"，而在于：**当主流框架的抽象边界和你的业务需求对不齐时，你该怎么办？**
