...
对话 Agent 负责对话，另外有一组**记忆 Agent**，负责提取记忆、结构化元数据、形成关联图谱。而且记忆 Agent 不止在对话时工作，它的亮点在于即使没有对话正在发生，它也会像梦游一样不断地遍历、检索、遗忘、优化已有的记忆结构。*就像人类通过睡觉来巩固记忆。*
...
同时这层关系连接本身就带有一种**短视性**。为什么说短视？问题就发生在文本分块。文本分块让这种关系分析本身就局限于一个小段落，甚至仅仅因为其中一句话。而通常作者希望这种联系是像主题阅读那种*全局观*，甚至完全只是一种 *feeling*。这种 feeling 或者全局观，是 RAG 所无法体现的。或者即使体现了，也淹没在了它所计算出来的大量低级联系当中。
